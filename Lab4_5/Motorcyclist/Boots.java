...
public class Boots extends Ammunition implements Serializable {
    Boots()
    {
        super();
    }
    public Boots(String name, int cost, int weightInGram) throws MyExceptionForLab4B { super(name, cost, weightInGram); }
