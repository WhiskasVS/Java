...
public class Motorcycle implements VehicleType {
    ...
    public Motorcycle(String nameOwner, String registrationNumber, String mark, String model, String vin, String typeOfDrivingForce,
                      boolean tech, boolean breakdown, int fuel, int quantityOfGear, int maxSpeed) throws Exception {
        ...
        if (fuel < 0 || quantityOfGear < 0 || maxSpeed < 0)
    ...
    public void setMaxSpeed(int maxSpeed) {
        if (maxSpeed < 0)
            throw new InvalidParameterException("Max speed cannot be less than 0!");
        this.maxSpeed = maxSpeed;
    }
