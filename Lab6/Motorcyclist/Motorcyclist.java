...
public class Motorcyclist implements Serializable {
    ...
    public Motorcyclist() throws MyExceptionForLab4B {
        name = "Unknown";
        ...
        for(int i = 0, j = 0; i < ammunition.length; i++) {
            ...
            switch (j) {
                case 1:
                    ammunition[i] = new Boots("Boots" , (int) (Math.random() * 7000), (int) (Math.random() * 4000));
                    break;
                case 2:
                    ammunition[i] = new Gloves("Gloves" , (int) (Math.random() * 7000), (int) (Math.random() * 4000));
                    break;
                case 3:
                    ammunition[i] = new Helmet("Helmet" , (int) (Math.random() * 7000), (int) (Math.random() * 4000));
                    break;
                case 4:
                    ammunition[i] = new Protection("Protection" , (int) (Math.random() * 7000), (int) (Math.random() * 4000));
                    break;
                case 5:
                    ammunition[i] = new Suit("Suit" , (int) (Math.random() * 7000), (int) (Math.random() * 4000));
                    break;
            }
        }
    }
